...
function HomeFooter() {
  return (
    <div className="lg:h-[200px] justify-around items-center flex-col flex lg:flex-row w-full bg-gradient-to-r from-slate-600 to-slate-950  ">
      <div>
        <p className="lg:text-4xl text-xl py-10 lg:py-0 text-white font-extrabold">
          Ck Odontologia
        </p>
      </div>
      <div className="flex flex-col ">
        ...
        <ul className="flex flex-col justify-start">
          ...
          <li>
            <a className="text-lg text-white" href="/serviços">
              Serviços
            </a>
          </li>
          <li>
            <a className="text-lg text-white" href="/sobrenos">
              Sobre nós
            </a>
          </li>
        </ul>
